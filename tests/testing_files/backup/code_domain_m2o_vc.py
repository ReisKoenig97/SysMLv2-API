...
@metadata("mass", "Code/Path", "g", "float", "PCB", "Motor.mass")
@metadata("speed", "newSndValue1Code", "rpm", "int", "PCB", "Motor.speed")
...
@metadata("path", "Code/Path", "", "String", "PCB", "Testing.path")
@metadata("port_name", "newSndValue1Code", "", "String", "PCB", "Testing.port_name")
#@metadata("component_name", "Component1NewName", "", "String", "PCB", "Testing.component_name")
class Testing:
...
def main():
    ...
    testingA = Testing(path = "Code/Path", port_name = "newSndValue1Code", component_name="")
